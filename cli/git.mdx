...
hyve cluster add monitoring-cluster --region PHX1
...
- [hyve cluster](/cli/cluster) - Manage cluster definitions stored in Git
- [hyve workflow](/cli/workflow) - Manage workflows stored in Git
- [hyve template](/cli/template) - Manage templates stored in Git
