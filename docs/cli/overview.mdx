...
<CardGroup cols={3}>
  ...
  <Card title="use" icon="circle-play" href="/docs/cli/use" color="#10b981">
...
Launches a full-screen guided TUI. Navigates all command groups — cluster, module, git, workflow, template, kubeconfig — with menus, select lists populated from live data, and back navigation at every level. No flags required.
