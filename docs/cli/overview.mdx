...
Launches a full-screen guided TUI. Navigates all command groups — cluster, template, git, workflow, kubeconfig — with menus, select lists populated from live data, and back navigation at every level. No flags required.
