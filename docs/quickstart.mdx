...
<Tip>
  **Prefer a guided experience?** After installing, run `hyve interactive` (alias: `hyve tui`). It walks you through every step below using interactive menus — no flags required.
</Tip>
...
Execute the template to create a cluster definition YAML and provision the cluster:
