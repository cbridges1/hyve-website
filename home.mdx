...
description: "Declarative cluster management for Civo Cloud with Git-native workflows"
---
...
Hyve is a **GitOps-first** Kubernetes cluster management CLI for Civo Cloud. Manage your entire infrastructure through Git repositories with automated workflows, secure credential management, and reusable templates.
...
<Card title="🎉 You're Ready!" icon="rocket" href="/quickstart">
...
<CardGroup cols={2}>
  <Card title="GitOps Workflow" icon="code-branch" href="/concepts/gitops">
  ...
  <Card title="Automated Workflows" icon="diagram-project" href="/workflows/overview">
    Define and execute deployment pipelines with validation
  </Card>

  <Card title="Cluster Templates" icon="stamp" href="/guides/template-management">
    Reusable cluster configurations with automated workflows
  </Card>

  <Card title="Secure Credentials" icon="key" href="/guides/credentials">
    Encrypted storage for API tokens and kubeconfigs
  </Card>

  <Card title="Variable Substitution" icon="code" href="/workflows/variables">
...
<Tabs>
  <Tab title="Multi-Environment">
    ...
    hyve cluster add prod-api --region NYC1 --nodes g4s.kube.large

    # Development environment
    hyve git add development --repo-url https://github.com/company/hyve-dev.git
    hyve git use development
    hyve cluster add dev-api --region PHX1 --nodes g4s.kube.small
    ```
  </Tab>
...
graph LR
    ...
    B --> E[Workflows]
    B --> F[Templates]
    C --> G[Kubernetes Clusters]
    A --> H[~/.hyve/]
    H --> I[Encrypted Credentials]
    H --> J[Kubeconfigs]
    H --> K[Repository State]
```
...
<CardGroup cols={3}>
  ...
  <Card title="Core Concepts" icon="book" href="/concepts/gitops">
