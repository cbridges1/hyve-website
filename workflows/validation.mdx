...
<CardGroup cols={2}>
  <Card title="YAML Validation" icon="file-check">
    Verify syntax and structure
  </Card>

  <Card title="Tool Checks" icon="wrench">
    Ensure required tools are installed
  </Card>

  <Card title="Secret Validation" icon="key">
    Verify secrets are available
  </Card>

  <Card title="Early Errors" icon="triangle-exclamation">
