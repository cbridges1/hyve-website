...
<CardGroup cols={2}>
  ...
  <Card title="Requirements" icon="list-check" href="/workflows/requirements">
  ...
  <Card title="Validation" icon="shield-check" href="/workflows/validation">
    Workflow validation
  </Card>
  ...
  <Card title="CLI Workflow" icon="terminal" href="/cli/workflow">
