...
hero:
  title: Hyve
  tagline: GitOps-first Kubernetes cluster management
  actions:
    - text: Get Started
...
<p style={{ textAlign: 'center', fontSize: '1.15rem', color: 'var(--sl-color-gray-2)', maxWidth: '640px', margin: '-1.5rem auto 3rem' }}>
