...
# If your environment directory is git-backed, commit it (optional — see Environments)
...
cat <environment directory>/workflows/deploy-app.yaml
```
...
```bash
# Edit workflow
vim <environment directory>/workflows/deploy-app.yaml
...
<AccordionGroup>
  <Accordion title="Workflow not found">
    ...
    **Solution:**
    ...
    # Verify file exists
    ls -la <environment directory>/workflows/
