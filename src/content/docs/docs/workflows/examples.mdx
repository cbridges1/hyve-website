...
<CardGroup cols={2}>
  ...
  <Card title="Requirements" icon="shield-check" href="/docs/workflows/requirements" color="#22c55e">
  ...
  <Card title="Validation" icon="check-double" href="/docs/workflows/validation" color="#22c55e">
    Validate workflows
  </Card>
</CardGroup>
