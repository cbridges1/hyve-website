...
<CardGroup cols={2}>
  ...
  <Card title="Module System" icon="cube" href="/docs/concepts/modules" color="#f43f5e">
    How credentials work with modules
  </Card>

  <Card title="CLI: Git Commands" icon="terminal" href="/docs/cli/git" color="#10b981">
