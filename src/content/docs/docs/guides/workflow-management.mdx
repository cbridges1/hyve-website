...
<Info>
  Pulling in a whole directory of workflows at once (`source: github.com/myorg/shared-workflows//platform/workflows/`, trailing slash) works with `hyve workflow install`, but not directly inside a lifecycle hook — a hook must reference exactly one workflow file.
</Info>

See [Remote Workflow References](/docs/cli/workflow#remote-workflow-references) in the CLI reference for the full source-string format and path-resolution rules.
...
<CardGroup cols={2}>
  ...
  <Card title="Template Management" icon="layer-group" href="/docs/guides/template-management" color="#8b5cf6">
    Templates with automated workflows
  </Card>

  <Card title="Kubeconfig Management" icon="key" href="/docs/guides/kubeconfig-management" color="#f43f5e">
    Manage cluster access
  </Card>

  <Card title="CLI: Workflow Commands" icon="terminal" href="/docs/cli/workflow" color="#10b981">
