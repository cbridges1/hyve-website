...
<CardGroup cols={2}>
  <Card title="Reusable Patterns" icon="stamp">
...
<CardGroup cols={2}>
  ...
  <Card title="Template Management" icon="stamp" href="/guides/template-management">
    Complete template guide
  </Card>

  <Card title="CLI Template" icon="terminal" href="/cli/template">
