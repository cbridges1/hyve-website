...
<CardGroup cols={2}>
  <Card title="Increased Velocity" icon="rocket">
  ...
  <Card title="Improved Security" icon="lock">
    All changes tracked with audit trails and approval workflows
  </Card>

  <Card title="Easy Rollbacks" icon="clock-rotate-left">
...
<CardGroup cols={2}>
  ...
  <Card title="Reconciliation" icon="arrows-rotate" href="/guides/cluster-management#reconciliation">
