...
| Event | When It Runs | Typical Use Cases |
|-------|--------------|-------------------|
| `onCreated` | After cluster is ready during reconcile | Setup monitoring, deploy apps, configure services |
| `onDestroy` | Before cluster deletion during reconcile | Backup data, export logs, cleanup external resources |
